...
public class Project_state_codeVO {
	private int pjt_state_code        ;	//분류코드 NUM
	private String pjt_state_code_val    ;	//코드값(미승인,승인,보류)
	
	public Project_state_codeVO() {}
	
	public Project_state_codeVO(int pjt_state_code, String pjt_state_code_val, String pjt_state_comment) {
		super();
	...
	public String toString() {
		return "Project_state_codeVO [pjt_state_code=" + pjt_state_code + ", pjt_state_code_val=" + pjt_state_code_val
				+ "]";
	}
