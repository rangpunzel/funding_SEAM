...
public class Pjt_bank_sum_attachVO {
	...
	public Pjt_bank_sum_attachVO() {	}
	
	public Pjt_bank_sum_attachVO(int pjt_atc_num, String pjt_atc_bankbook_path, String pjt_atc_bankbook_name,
			String pjt_atc_sum_path, String pjt_atc_sum_name, Date pjt_atc_regdate, Date pjt_atc_moddate, int pjt_num) {
		super();
	...
	public String toString() {
		return "Pjt_bank_sum_attachVO [pjt_atc_num=" + pjt_atc_num + ", pjt_atc_bankbook_path=" + pjt_atc_bankbook_path
				+ ", pjt_atc_bankbook_name=" + pjt_atc_bankbook_name + ", pjt_atc_sum_path=" + pjt_atc_sum_path
				+ ", pjt_atc_sum_name=" + pjt_atc_sum_name + ", pjt_atc_regdate=" + pjt_atc_regdate
				+ ", pjt_atc_moddate=" + pjt_atc_moddate + ", pjt_num=" + pjt_num + "]";
	}
