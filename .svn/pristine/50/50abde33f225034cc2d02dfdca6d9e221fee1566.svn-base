...
<script>
	$('#registBtn').on('click',function(e){
		...
		var content = "안녕하세요 펀심딩입니다 <br> 문의해주셔서 감사합니다 <br>질문내용과 답변내용 : <br>" + con + "더 자세한 내용은  <a href='http://localhost/qna/detail?qna_num=${qna.qna_num }'>www.funseamding.qna/detail.com</a>를 참고해주세요<br> 좋은하루 되세요!";
