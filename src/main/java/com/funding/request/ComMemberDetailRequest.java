...
public class ComMemberDetailRequest {
	...
	public ComMemberDetailRequest() {}
	public ComMemberDetailRequest(int mem_num, String mem_email, String mem_pw, String mem_name, String mem_phone,
			...
			String com_state_code_val, String com_state_comment) {
		super();
		this.mem_num = mem_num;
		this.mem_email = mem_email;
		this.mem_pw = mem_pw;
	...
	public String toString() {
		return "ComMemberDetailRequest [mem_num=" + mem_num + ", mem_email=" + mem_email + ", mem_pw=" + mem_pw
				...
				+ com_state_code_val + ", com_state_comment=" + com_state_comment + "]";
	}
