...
public class Project_type_codeVO {
	private int pjt_type_code;		//분류코드(num)
	private String pjt_type_code_val;//코드값(기부,대출)
	
	public Project_type_codeVO() {}
	
	public Project_type_codeVO(int pjt_type_code, String pjt_type_code_val) {
		super();
	...
	public String toString() {
		return "Project_type_codeVO [pjt_type_code=" + pjt_type_code + ", pjt_type_code_val=" + 		pjt_type_code_val + "]";
	}
